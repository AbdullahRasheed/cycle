...
public class DBCache<K, V extends DBStorable> {
    ...
    private final Function<DBObject, V> converter;
     ...
     */
    public DBCache(MongoClient client, String db, String collection, Function<DBObject, V> converter){
    ...
    public V retrieve(K key){
        ...
        return converter.apply(cursor.one());
    }
